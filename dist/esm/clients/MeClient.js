import { getBookmark, getNotification, login, setConfig, setNotificationRead, } from "../packages/me";
export class MeClient {
     ...
     */
    login(token) {
        return login.call(this.parent, token, this.userAgent);
    }
    /**
     ...
     */
    setNotificationRead() {
        return setNotificationRead.call(this.parent, this.userAgent);
    }
    /**
     * ユーザーの設定を変更します。
     ...
     */
    setConfig(props) {
        return setConfig.call(this.parent, this.userAgent, props);
    }
    /**
     * ユーザーのブックマークを取得します。
