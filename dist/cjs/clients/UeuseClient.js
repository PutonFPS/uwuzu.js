...
exports.UeuseClient = void 0;
const ueuses_1 = require("../packages/ueuses");
class UeuseClient {
    parent;
    userAgent;
     ...
     */
    create(props) {
        return ueuses_1.create.call(this.parent, this.userAgent, props);
    }
    /**
     * ユーズを削除します。
     ...
     */
    remove(uniqId) {
        return ueuses_1.remove.call(this.parent, this.userAgent, uniqId);
    }
}
exports.UeuseClient = UeuseClient;
